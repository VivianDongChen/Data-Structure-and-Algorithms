...
public class LeetCode_0098 {
    ...
    public static void main(String[] args) {
        TreeNode root1 = new TreeNode(4,
                                       ...
                                       new TreeNode(6));
        System.out.println(new LeetCode_0098().isValidBST5(root1));

        TreeNode root2 = new TreeNode(4,
                                       new TreeNode(2),
                                       new TreeNode(6,new TreeNode(3),new TreeNode(7)));
        System.out.println(new LeetCode_0098().isValidBST5(root2));

        TreeNode root3 = new TreeNode(1,
                                       new TreeNode(1),
                                 null);
        System.out.println(new LeetCode_0098().isValidBST5(root3));
        ...
        TreeNode root4 = new TreeNode(3,
                                  null,
                                       new TreeNode(4,
                                                     new TreeNode(5),
                                               null));
        System.out.println(new LeetCode_0098().isValidBST4(root4));
    }
}
