...
public class LeetCode0234PalindromeLinkedList {
    ...
    public static void main(String[] args) {
        System.out.println(new LeetCode0234PalindromeLinkedList().isPalindrome2(ListNode.of(1,2,2,1)));
        System.out.println(new LeetCode0234PalindromeLinkedList().isPalindrome2(ListNode.of(1,2,3,2,1)));
        System.out.println(new LeetCode0234PalindromeLinkedList().isPalindrome2(ListNode.of(1,2,3,2,4)));
    }
}
